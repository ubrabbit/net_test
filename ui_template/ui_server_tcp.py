...
class CInterfaceUnit(ui_template.CTemplateBase):
    ...
    def init_interface(self):
        ...
        self.main_Layout.setStretchFactor( layout_Horizon_0,1 )
        self.main_Layout.setStretchFactor( layout_Vector_4,2 )
        self.main_Layout.setStretchFactor( layout_Horizon_1,7 )
